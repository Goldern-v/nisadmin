...
const urlFromHospitalId = (HOSPITAL_ID) => {
  ...
  switch (HOSPITAL_ID) {
    ...
    case 'hj':
      ...
      return "http://192.168.1.54:9866" // 公司-厚街测试
    /** 南医三 */
    case 'nys':
      // return 'http://119.145.71.86:9801' // 南医三正式
      // return 'http://119.145.71.86:9098' // 南医三测试
      return 'http://192.168.1.54:8062' //公司-南医三测试
    /** 武汉 */
    case 'wh':
    ...
    /** 花都 */
    case 'gzhd':
      return 'http://192.168.1.54:9868' // 公司-花都测试
    /** 江门妇幼 */
    case 'jmfy':
      // return 'http://218.14.180.38:9094' // 公司-江门妇幼正式
      return 'http://192.168.1.54:9872' // 公司-江门妇幼测试
    /** 默认公司本地厚街测试环境 */
    default:
