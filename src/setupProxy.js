...
const urlFromHospitalId = (HOSPITAL_ID) => {
    ...
    switch (HOSPITAL_ID) {
        ...
        case "nys":
            ...
            return 'https://info.cr-health.com:20203' //公司-南医三测试-外网
        ...
        /**临邑人民医院 */
        case "lyrm":
            return 'http://192.168.20.153:8080'
        ...
        // return "http://192.168.3.163:8080";//福俊本地
        // 武汉汉口医院
        case "whhk":
            // 正式
            return "http://ydyl.whshkyy.com:9094";
        ...
        // 珠海中西医
        case "zhzxy":
            return "https://info.cr-health.com:20203"; //测试
        case "zjhj":
            return "https://info.cr-health.com:20203"; //测试
        default:
            // return "http://192.168.1.54:9866";
