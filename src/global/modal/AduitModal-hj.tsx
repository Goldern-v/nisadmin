          ...
          <InfoTable>
            <tbody>
              {tableData.map((obj: any, index: number) => (
                <tr key={index+Math.random()+Object.keys(obj)[0]}>
                  ...
                  <td>
                    { Object.keys(obj)[1] &&
                      <Input
                      placeholder=''
                      defaultValue={obj[Object.keys(obj)[1]]}
                      onChange={e => {
                        obj[Object.keys(obj)[1]] = e.target.value
                      }}
                    />}
                    {/* {Object.keys(obj)[1] && <Value>{obj[Object.keys(obj)[1]]}</Value>} */}
                  </td>
                </tr>
              ))}
            </tbody>
