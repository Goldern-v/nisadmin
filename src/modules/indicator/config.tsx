...
export const LEFT_MENU = [
  {
    ...
    children: [
      ...
      { title: '插管患者非计划拔管发生率', path: '/indicator/插管患者非计划拔管发生率' },
      { title: '导尿管相关尿路感染发生率', path: '/indicator/导尿管相关尿路感染发生率' },
      { title: '中心导管相关血流感染发生率', path: '/indicator/中心导管相关血流感染发生率' },
      { title: '呼吸机相关性肺炎发生率', path: '/indicator/呼吸机相关性肺炎发生率' },
  ...
  },
  {
    ...
    children: [
      ...
      { title: '导管相关血液感染发生率', path: '/indicator/导管相关血液感染发生率' },
      { title: '尿管相关泌尿系感染发生率', path: '/indicator/尿管相关泌尿系感染发生率' },
      { title: '手术相关肺部感染发生率', path: '/indicator/手术相关肺部感染发生率' },
      { title: '患者入院前已有压疮统计', path: '/indicator/患者入院前已有压疮统计' },
      { title: '入院时压疮高风险患者评估率', path: '/indicator/入院时压疮高风险患者评估率' },
      { title: '住院压疮高风险压疮发生率', path: '/indicator/住院压疮高风险压疮发生率' },
      { title: '住院患者手术室压疮发生率', path: '/indicator/住院患者手术室压疮发生率' },
      { title: '排便失禁患者失禁性皮炎发生率', path: '/indicator/排便失禁患者失禁性皮炎发生率' },
      { title: '跌倒坠床高风险患者评估率', path: '/indicator/跌倒坠床高风险患者评估率' },
      { title: '住院患者跌倒发生率', path: '/indicator/住院患者跌倒发生率' },
      { title: '住院患者跌倒坠床伤害程度', path: '/indicator/住院患者跌倒坠床伤害程度' },
      { title: '住院患者误吸高风险评估率', path: '/indicator/住院患者误吸高风险评估率' },
      { title: '住院高风险患者误吸发生率', path: '/indicator/住院高风险患者误吸发生率' },
      { title: '患者走失高风险患者评估率', path: '/indicator/患者走失高风险患者评估率' },
  ...
  },
  {
    ...
    children: [
      ...
      { title: '使用药物错误的发生率', path: '/indicator/使用药物错误的发生率' },
      { title: '急救设备器材及药品完好合格率', path: '/indicator/急救设备器材及药品完好合格率' },
