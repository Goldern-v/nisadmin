        ...
        <tbody>
          ...
          {appStore.hisMatch({
            map: {
              nys: (
                <tr>
                  <td className="key">学习结束时间：</td>
                  <td className="value">
                    {xxStepViewModal.stepData2.endTime &&
                      moment(xxStepViewModal.stepData2.endTime).format(
                        "YYYY-MM-DD HH:mm"
                      )}
                  </td>
                </tr>
              ...
              other: (
                <tr>
                  ...
                  <td className="value">
                    ...
                    <span className="aside">即：{xxStepViewModal.getEndTime} 结束</span>
                  </td>
                </tr>
              )
            }
