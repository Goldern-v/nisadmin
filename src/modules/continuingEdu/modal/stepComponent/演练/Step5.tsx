        ...
        <tbody>
          ...
          {appStore.hisMatch({
            map: {
              nys: (
                <tr>
                  <td className="key">演练结束时间：</td>
                  <td className="value">
                    {ylStepViewModal.stepData2.endTime &&
                      moment(ylStepViewModal.stepData2.endTime).format(
                        "YYYY-MM-DD HH:mm"
                      )}
                  </td>
                </tr>
              ...
              other: (
                <tr>
                  ...
                  <td className="value">
                    ...
                    <span className="aside">即：{ylStepViewModal.getEndTime} 结束</span>
                  </td>
                </tr>
              )
            }
          ...
          <tr>
            ...
            <td className="value">
              {organizationWayMap[ylStepViewModal.stepData2.organizationWay]}
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td className="value">
              {ylStepViewModal.stepData2.bxNurse
          ...
          <tr>
            ...
            <td className="value">
              <Radio
                checked={!!ylStepViewModal.stepData5.ifSendMessage}
                onClick={() => {
                  ylStepViewModal.stepData5.ifSendMessage = !ylStepViewModal
          ...
          <tr>
            ...
            <td className="value">
              <Input.TextArea
                ...
                value={ylStepViewModal.stepData2.noticeContent}
                onChange={(e: any) =>
                  (ylStepViewModal.stepData2.noticeContent = e.target.value)
                }
              />
            </td>
          </tr>
