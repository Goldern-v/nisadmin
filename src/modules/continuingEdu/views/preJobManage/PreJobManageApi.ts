...
export default class PreJobManageApi extends BaseApiService {
  ...
  /**培训列表导出 */
  public async exportWithTE(obj?: any) {
    return this.post("/newNurseMange/trainExam/export", obj, {
      responseType: "blob",
    });
  }
  /**实操列表导出 */
  public async exportWithTESC(obj?: any) {
    return this.post("/newNurseMange/trainExamSC/export", obj, {
      responseType: "blob",
    });
  }
  /**详情导出 */
  public async exportWithTED(obj?: any) {
    return this.post("/newNurseMange/trainExamDetail/export", obj, {
      responseType: "blob",
    });
  }
  /**检查权限 */
