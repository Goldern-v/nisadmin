...
export default observer(function ExamPrint(props: Props) {
  ...
  return (
    <Wrapper ref={props.printRef} id="wardLogPrintPage">
      {hjExamModal.keyIdx == '0' && <ContentSpecial>
        <Title>考试情况统计</Title>
        <table>
          <colgroup>
            <col width="10%" />
          ...
          <tbody>
            ...
            {hjExamModal.statisticsTableList.map((item: any, index: any) => (
              <tr key={index}>
                ...
                <td style={{ textAlign: "center" }}>{item.totalHandInTimes}</td>
                <td style={{ textAlign: "center" }}>{item.totalScoresDesc}</td>
                <td style={{ textAlign: "center" }}>{item.resitTotalScoresDesc}</td>
                <td style={{ textAlign: "center" }}>{item.startTime}-{item.endTime}</td>
              </tr>
            ))}
          </tbody>
        </table>
      </ContentSpecial>}
      {hjExamModal.keyIdx == '1' && <ContentSpecial>
        <Title>考试情况分析</Title>
        <table>
          <colgroup>
            <col width="17%" />
          ...
          <tbody>
            ...
            {hjExamModal.analyseTableList.map((item: any, index: any) => (
              <tr key={index}>
                ...
                <td style={{ textAlign: "center" }}>{item.passPersonCount}</td>
                <td style={{ textAlign: "center" }}>{item.passRate * 100}%</td>
