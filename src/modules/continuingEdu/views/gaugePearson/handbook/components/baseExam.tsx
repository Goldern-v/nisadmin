...
import {DatePicker, Button, message, Modal, InputNumber} from "src/vendors/antd";
    ...
    const columns: any = [
        ...
        },
        {
            ...
            render: (value: any, row: any) => {
                ...
                return (<InputNumber style={{width: 'auto'}} precision={2} min={0} max={100} key={row.id}
                                     defaultValue={value} onBlur={(e: any) => {row.score = e.target.value }}/>)
            }
        },
        {
            title: "考核人签名",
    ...
    return (
        <Wrapper>
            ...
            <BaseTable
                ...
                surplusHeight={exportData ?undefined:350}
            />
