...
export default observer(function SetConfig(props: Props) {
    ...
    const columns: ColumnProps<any>[] = [
                            ...
                            return (
                                <Cascader changeOnSelect={true}
                                              ...
                                              if (selectedOptions[0].multiple) {
                                                  ...
                                                  return <div className="tag-list">
                                                      {record.timeBeginCode &&
                                                          <Tag color="lime" closable onClose={() => {
                                                              record.timeBeginCode = ''
                                          ...
                                          onChange={(value: any, l: any) => {
                                              ...
                                              if (['text', 'sign', 'attachment'].includes(value[0])) {
                                                  record.defaultValue = ''
                                              }

                                              /*设置对应默认值*/
                                              if (value[0] == 'date') {
                                                  record.defaultValue = moment().format('YYYY-MM-DD')
                                              }
                                              if (value[0] == 'date_time') {
                                                  record.defaultValue = moment().format('YYYY-MM')
                                              }
                                              if (value[0] == 'time') {
                                                  record.defaultValue = moment().format('YYYY-MM-DD HH:mm')
                                              }
        ...
        /*默认开启*/
        {
            ...
            dataIndex: 'nullUse',
            render(text: boolean, record: any) {
                return <Switch checked={text} onChange={(checked: boolean) => {
