...
import { Button, Input, message as Message, Modal, Select } from 'antd'
...
export default withRouter(
  observer(function 健康宣教字典(props: Props) {
    //导入弹窗相关
    ...
    const columns: ColumnProps<any>[] = [
      ...
      // },
      {
        ...
        render: (text: string, record: any) => {
          return (
            <Fragment>
              <span onClick={(e) => viewContent(record)} className='operation-span'>
                查看
              </span>
              <span onClick={(e) => handleDelete(record)} className='operation-span delete-span'>
                删除
              </span>
            </Fragment>
          )
    ...
    return (
      <Wrapper>
        <div className='topbar'>
          ...
          <div className='float-right'>
            ...
            <span className='search-input'>
              <Input
                value={query.name}
                onChange={(e: any) => setQuery({ ...query, name: e.target.value })}
                allowClear
              />
            </span>
            <span className='btn-group'>
              ...
              <Button className='upload' onClick={handleUploadBtn}>
                导入
              </Button>
        ...
        >
          <ModalWrapper>
            <Input value={fileName} className='file-name-input' readOnly />
            <Button onClick={triggerFileUpload}>选择</Button>
            <input
              type='file'
              id='fileUpload'
              style={{ display: 'none' }}
