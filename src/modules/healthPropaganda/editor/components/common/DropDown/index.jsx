...
import ResponsiveHelper from 'src/modules/badEvents/views/editor/helpers/responsive'
  ...
  render() {
    ...
    return (
      <div className={'bf-dropdown ' + (active ? 'active ' : '') + (disabled ? 'disabled ' : '') + className}>
        ...
        >
          <i style={{ marginLeft: offset * -1 }} className={'dropdown-arrow' + (arrowActive ? ' active' : '')} />
