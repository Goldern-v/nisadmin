...
export default observer(function 护士初始学历分布() {
  ...
  const getData = () => {
    setLoading(true)
    let jmfyQuery ={...query}
    statisticsApi.countInitialEducation(appStore.HOSPITAL_ID !== 'jmfy'? {deptCode:query.deptCode}:jmfyQuery)
      .then((res: any) => {
        setLoading(false)
  ...
  return <CommonLayout
    ...
    body={<Spin spinning={loading}>
      <div className="main-title">护士初始学历分布</div>
