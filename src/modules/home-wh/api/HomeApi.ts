...
class StatisticsApi extends BaseApiService {
  ...
  /** 4、继续教育 */
  public async getMyNotificationList() {
    return this.get("/studyAndTrain/noticeManage/getMyNotificationListForPc");
  }

  /** 5、继续教育更多-获取我的消息通知*/
  public async getMyNotificationsByPageForPc(obj: any) {
    return this.post(
      "/studyAndTrain/noticeManage/getMyNotificationsByPageForPc",
      obj
    );
  }

  /** 5、继续教育通知-阅读消息通知*/
  public async readNotification(id: any) {
    return this.post(
      "/studyAndTrain/noticeManage/readNotification",
      qs.stringify({ id })
    );
  }
