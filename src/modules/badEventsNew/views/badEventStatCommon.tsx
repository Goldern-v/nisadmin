...
export default observer(function 不良事件统计() {
    ...
    try {
      setTimeout(() => {
        if (
          ...
          ).style.width = tableData[0]?.eventTypeCount?.length * 70 + "px";
        } else {
  ...
  return <Wrapper>
    ...
    <MidCon>
      ...
      {viewType == 'table' && <TableCon id="arrangeSheet">
        <BaseTable
          loading={loading}
