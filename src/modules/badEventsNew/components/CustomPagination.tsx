...
export interface Props {
  ...
  hideSizeInput?: Boolean
}

export default function CustomPagination(props: Props) {
  const { total, size, page, onChange, onShowSizeChange, hideSizeInput } = props;
  const totalPage = () => {
  ...
  return <Wrapper className="custom-pagination">
    <div className="float-left" style={{ display: hideSizeInput ? 'none' : 'inline-block' }}>
