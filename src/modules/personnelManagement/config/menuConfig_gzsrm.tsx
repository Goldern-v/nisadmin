...
import StarRatingReportListGzsrm from "../views/arrangeHome/page/nightChargingReport/StarRatingReportListGzsrm";
...
import nightChargingTotle from "src/modules/personnelManagement/views/arrangeHome/page/nightChargingTotle/nightChargingTotleList";//夜班统计
