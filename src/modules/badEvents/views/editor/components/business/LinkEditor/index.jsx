...
import ControlGroup from 'src/modules/badEvents/views/editor/components/business/ControlGroup'
        ...
        >
          <div className='bf-link-editor'>
            ...
            <div className='buttons'>
              ...
              <button type='button' onClick={this.handleCancel} className='default pull-right'>
