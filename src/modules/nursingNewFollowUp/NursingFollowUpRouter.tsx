  ...
  const getAuthMenu = () => {
    ...
    setTimeout(() => {
      ...
      setAuthMenu([
        ...
        {
          title: '随访患者管理',
          path: '/nursingNewFollowUp/随访患者管理',
          props: {
            可随访: true,
            可随访分配护士: false
          },
        ...
        {
          title: '随访小组管理',
          path: '/nursingNewFollowUp/随访小组管理',
          props: {
            可随访: true,
            可随访分配护士: false
          },
        ...
        {
          title: '随访问卷管理',
          path: '/nursingNewFollowUp/随访问卷管理',
          props: {
            可随访: true,
            可随访分配护士: false
          },
