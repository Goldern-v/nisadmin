...
export default class QualityAnalysisReportService extends BaseApiService {
  ...
  public deleteReport(obj?: any) {
    return this.get(`/missionReportInstance/deleteReport/${appStore.queryObj.id}`)
  }
  public publishReport(obj?: any) {
    return this.get(`/missionReportInstance/publish/${appStore.queryObj.id}`)
  }
  public cancelPublishReport(obj?: any) {
    return this.get(`/missionReportInstance/cancelPublish/${appStore.queryObj.id}`)
  }
