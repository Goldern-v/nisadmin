...
export default observer(function WardInnovate() {
  ...
  const getTableData = () => {
    nurseFilesService.commonfindByEmpNoSubmit('nurseWHInnovationDept', appStore.queryObj.empNo).then((res) => {
  ...
  const columns: ColumnProps<any>[] = [
    ...
    //   }
    // },
    Do('nurseWHInnovationDept', editOnEducationModal, getTableData)
  ]
