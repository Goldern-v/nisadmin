        ...
        <Row>
          ...
          <Col span={24}>
            <Form.Field label={`证书名称`} name='participant'>
              <AutoComplete value={nurseFileDetailViewModal.getDict('级别')[0]?.name} filterOption dataSource={nurseFileDetailViewModal.getDict('级别').map((item) => item.name)} />
            </Form.Field>
          </Col>
        {nurseFileDetailViewModal.getDict('级别')[0]?.name}
          <Col span={24}>
