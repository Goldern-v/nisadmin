...
export default function EditPersonWinningModal(props: Props) {
  ...
  const onSave = async (sign: boolean) => {
    ...
    value.year && (value.year = value.year.format('YYYY-MM-DD'))
    ...
    >
      <Form ref={refForm} rules={rules} labelWidth={120} onChange={onFieldChange}>
        <Row>
          ...
          <Col span={24}>
                <Form.Field label={`授课题目`} name='schoolArea'>
                  <Input />
                </Form.Field>
              </Col>
              <Col span={24}>
                <Form.Field label={`学分类别`} name='personTitleArea'>
                  <Input />
                </Form.Field>
              </Col>
          <Col span={24}>
            <Form.Field label={`学分`} name='projectNumber'>
              <Input />
            </Form.Field>
          </Col>
          <Col span={24}>
            <Form.Field label={`级别`} name='projectLevel'>
