...
const rules: Rules = {}
export default function EditMakeAwardsModal(props: Props) {
  ...
  const onSave = async (sign: boolean) => {
    ...
    nurseFilesService.commonSaveOrUpdate('nurseWHRewardExperience', { ...obj, ...value, sign }).then((res: any) => {
    ...
    >
      <Form ref={refForm} labelWidth={100} onChange={onFieldChange} rules={rules}>
        <Row>
          ...
          <Col span={24}>
            <Form.Field label={`嘉奖名称`} name='rewardName'>
              <Input />
            </Form.Field>
          </Col>
