...
import { AutoComplete, Button, Checkbox, Icon, Input, message, Modal, Radio, Select, Spin } from 'antd'
...
import { selectPeopleViewModel as selectPeopleViewModel_com } from '../model/SelectPeopleModel'
                  ...
                  <FileList>
                    {selectPeopleViewModel.selectTreeData.map(
                      (item: any, index: any) => (
                        ...
                        >
                          <img
                            src={require("@/modules/continuingEdu/images/文件夹.png")}
                            alt=""
                          />
