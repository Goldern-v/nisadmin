...
export default observer(function QcMonthCheckTwo(props) {
  const { isPrint } = props

  const { YTLL_YDHZFX_L2_003:
  ...
  const wardQcProblemMapList = ()=>{
    const { YTLL_YDHZFX_L2_004:{wardQcProblemMap}} = qcMonthCheckData
  ...
  const qcProblemSummaryList = ()=>{
    const { YTLL_YDHZFX_L2_005:{qcProblemSummaryList}} = qcMonthCheckData
    ...
    <>
      <div className='first-content-box'>
        <div className='first-title mg-bt-20'>{`一、质控人员`}</div>
          <p className="p-txt txt-indent-40 mg-bt-20">{qcMonthCheckData.YTLL_YDHZFX_L2_001.qcPersonName}</p>
      </div>
      <div className='first-content-box'>
        <div className='first-title mg-bt-20'>{`二、质控项目`}</div>
          <p className="p-txt txt-indent-40 mg-bt-20">{qcMonthCheckData.YTLL_YDHZFX_L2_002.qcTemplateName}</p>
      </div>
      <div className='first-content-box'>
        <div className='first-title mg-bt-20'>{`三、质控结果`}</div>
        <div className="txt-indent-40">
          此次质控共质控
          <InputNumber  min={0}  size="small" value={qcMonthCheckData.YTLL_YDHZFX_L2_003.qcItemDepartCount} onChange={(val:any)=>qcMonthCheckData.YTLL_YDHZFX_L2_003.qcItemDepartCount = val} />
          个科室、
          <InputNumber  min={0} size="small" value={qcMonthCheckData.YTLL_YDHZFX_L2_003.qcItemWardCount} onChange={(val:any)=>qcMonthCheckData.YTLL_YDHZFX_L2_003.qcItemWardCount = val} />
      ...
      <div className='first-content-box mg-bt-20'>
        ...
        <div className='second-title mg-bt-20'>
          {`原因分析`}
          <Input.TextArea autosize={{ minRows: 5}} value={qcMonthCheckData.YTLL_YDHZFX_L2_006.reason}
            onChange={(e)=>qcMonthCheckData.YTLL_YDHZFX_L2_006.reason = e.target.value} />
        </div>
        <div className='second-title mg-bt-20'>
          {`整改措施`}
          <Input.TextArea autosize={{ minRows: 5}} value={qcMonthCheckData.YTLL_YDHZFX_L2_006.doSomething}
            onChange={(e)=>qcMonthCheckData.YTLL_YDHZFX_L2_006.doSomething = e.target.value} />
        </div>
      </div>
      <div className='first-content-box mg-bt-20'>
        <div className='first-title mg-bt-20'>{`七、效果评价`}</div>
          <Input.TextArea autosize={{ minRows: 5}} value={qcMonthCheckData.YTLL_YDHZFX_L2_007.pingjia}
            onChange={(e)=>qcMonthCheckData.YTLL_YDHZFX_L2_007.pingjia = e.target.value} />
      </div>
    </>
  )
})