    ...
    <>
      <div className='first-content-box'>
        <div className='first-title mg-bt-20'>{`一、质控人员`}</div>
          <p className="p-txt txt-indent-40 mg-bt-20">{qcMonthCheckData.YTLL_YDHZFX_L1_001.qcPersonName}</p>
      </div>
      <div className='first-content-box'>
        <div className='first-title mg-bt-20'>{`二、质控项目`}</div>
          <p className="p-txt txt-indent-40 mg-bt-20">{qcMonthCheckData.YTLL_YDHZFX_L1_002.qcTemplateName}</p>
      </div>
      <div className='first-content-box'>
      ...
      <div className='first-content-box mg-bt-20'>
        ...
        <div className='second-title mg-bt-20'>
          {`原因分析`}
          <Input.TextArea autosize={{ minRows: 5}} value={qcMonthCheckData.YTLL_YDHZFX_L1_005.reason}
            onChange={(e)=>qcMonthCheckData.YTLL_YDHZFX_L1_005.reason = e.target.value} />
        </div>
        <div className='second-title mg-bt-20'>
          {`整改措施`}
          <Input.TextArea autosize={{ minRows: 5}} value={qcMonthCheckData.YTLL_YDHZFX_L1_005.doSomething}
            onChange={(e)=>qcMonthCheckData.YTLL_YDHZFX_L1_005.doSomething = e.target.value} />
        </div>
      </div>
      <div className='first-content-box mg-bt-20'>
        <div className='first-title mg-bt-20'>{`六、效果评价`}</div>
          <Input.TextArea autosize={{ minRows: 5}} value={qcMonthCheckData.YTLL_YDHZFX_L1_006.pingjia}
            onChange={(e)=>qcMonthCheckData.YTLL_YDHZFX_L1_006.pingjia = e.target.value} />
      </div>
    </>
  )
})