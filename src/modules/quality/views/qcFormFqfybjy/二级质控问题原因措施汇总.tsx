    ...
    },
    {
      ...
      render: (text: any, record: any) => (
        <EditList
          ...
          input={(e: any) => saveTableData(e, "trackingDate", record)}
          save={() => saveContent("trackingDate", text)}
        />
      ),
    },
    {
      ...
      render: (text: any, record: any) => (
        <EditList
          arr={text}
          editList={["content"]}
          input={(e: any) => saveTableData(e, "trackingEvaluate", record)}
          save={() => saveContent("trackingEvaluate", text)}
        />
      ),
    },
    {
      ...
      render: (text: any, record: any) => (
        <EditList
          arr={text}
          editList={["author"]}
          input={(e: any) => saveTableData(e, "trackingAuthor", record)}
          save={() => saveContent("trackingAuthor", text)}
        />
      ),
    },
  ];
