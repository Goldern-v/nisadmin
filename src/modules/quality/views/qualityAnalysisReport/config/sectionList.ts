...
import 本月质量扣分质控表排序模块 from '../components/本月质量扣分质控表排序/本月质量扣分质控表排序模块'
import 本月质量扣分质控表排序弹窗 from '../components/本月质量扣分质控表排序/本月质量扣分质控表排序弹窗'
...
export const sectionListOne:SectionListItem[]=[
  {
    sectionId: '报告名称',
    sectionTitle: '报告名称',
    modalTitle: '编辑报告名称',
 ...
 {
    sectionId: '本月质量扣分质控表排序',
    sectionTitle: '本月质量扣分质控表排序',
    modalTitle: '编辑本月质量扣分质控表排序',
    modalWidth: 900,
    data: {},
    section: 本月质量扣分质控表排序模块,
    modal: 本月质量扣分质控表排序弹窗
  },
  {
    sectionId: '本月主要质量问题',
