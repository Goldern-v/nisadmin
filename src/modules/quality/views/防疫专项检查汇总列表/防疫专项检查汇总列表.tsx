...
import CreateWorkSummaryReportModal from './components/CreateReportModal'
import qs from 'qs'
import { useKeepAliveEffect } from 'src/vendors/keep-alive'

const api = new ReportListService()
const Option = Select.Option

export default observer(function 防疫专项检查片区汇总列表() {
  ...
  const handleReview = (record: any) => {
    ...
    // console.log(record)
    history.push(`/防疫专项检查汇总报告?${qs.stringify(obj)}`)
  }
    ...
    <Wrapper>
      <div className='topbar'>
        <div className='float-left'>
          <PageTitle>防疫专项检查汇总报告</PageTitle>
        </div>
