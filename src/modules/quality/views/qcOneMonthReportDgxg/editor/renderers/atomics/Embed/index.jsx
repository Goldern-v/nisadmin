...
import PlayerModal from 'src/modules/badEvents/views/editor/components/business/PlayerModal'
  ...
  render() {
    ...
    return (
      <div className='bf-embed-wrap'>
        ...
        >
          <div className='bf-embed-player' dangerouslySetInnerHTML={{ __html: url }} />
        </PlayerModal>
      </div>
    )
  }
