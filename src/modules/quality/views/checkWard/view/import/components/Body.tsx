...
export default function Body() {
  ...
  const toImport = (files: any) => {
    ...
    checkWardService.importSearchRoom(form).then(
      (res) => {
      ...
      <Content>
        <MainBox>
          {type === 1 ? (
            <div>
              ...
              <div className='button'>
                <Button type='primary' onClick={importPlan}>
                  <span className='leftMargin' />上传查房计划<span className='rightMargin' />
                </Button>
            ...
            <div>
              <Icon type='loading' style={{ fontSize: 100, margin: '75px 117px 30px 117px', color: '#00A680' }} />
            ...
            <div>
              ...
              <div className='button button1'>
                <Button type='primary' onClick={pushPlan}>
                  <span className='leftMargin' />推送查房计划<span className='rightMargin' />
                </Button>
              ...
              <div className='button'>
                <Button
                  onClick={() => {
                    appStore.history.push(`/quality/checkWard/schedule`)
                  }}
                >
                  <span className='leftMargin1' />返回<span className='rightMargin1' />
                </Button>
              </div>
            </div>
          ) : (
        ...
        <Warning>
          <div className='content'>
            ...
            <p className='explain'>
              2. 请设置文件名为：年度+查房类型.xls，如2019年中夜班查房计划.xls或2019年特殊查房计划。
            </p>
          </div>
        </Warning>
        {FileInput()}
