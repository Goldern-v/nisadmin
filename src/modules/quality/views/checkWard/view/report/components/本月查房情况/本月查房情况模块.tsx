...
export default observer(function 本月查房情况模块(props: Props) {
  ...
  return (
    <Wrapper>
      ...
      <div className='text-box'>{checkWardReportViewModal.year}年{checkWardReportViewModal.month}月特殊时段查房共{checkWardReportViewModal.searchRoom2}次，中夜班查房共{checkWardReportViewModal.searchRoom1}次。</div>
