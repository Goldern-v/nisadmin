...
export default observer(function MainLayout(props: Props) {
  ...
  let aduitModal = appStore.hisMatch({
    map: {
      "wh,gzsrm,gxjb,fsxt,fssdy,whyx,sdlj,lyrm,gdtj,qhwy,lyyz,wjgdszd,zzwy,zhzxy,whhk,925,ytll,dglb,whsl,stmz": createModal(AduitModalWh),
  ...
  let groupsAduitModal = appStore.hisMatch({
    map: {
      ...
      "wh,gzsrm,gxjb,fsxt,fssdy,whyx,sdlj,lyrm,gdtj,qhwy,lyyz,wjgdszd,zzwy,zhzxy,whhk,925,ytll,dglb,whsl,stmz": createModal(GroupsAduitModalWh),
