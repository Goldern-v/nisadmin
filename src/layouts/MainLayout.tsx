...
export default observer(function MainLayout(props: Props) {
  ...
  let aduitModal = appStore.hisMatch({
    map: {
      "wh,gzsrm,gxjb,fsxt,fssdy,whyx,sdlj, lyrm,gdtj,qhwy,lyyz": createModal(AduitModalWh),
  ...
  let groupsAduitModal = appStore.hisMatch({
    map: {
      ...
      "wh,gzsrm,gxjb,fsxt,whyx,sdlj, lyrm,gdtj,qhwy,lyyz": createModal(GroupsAduitModalWh),
