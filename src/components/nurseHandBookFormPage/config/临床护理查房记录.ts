...
const complexHead: any = {
  boxWidth: 700,
  complexHeadList:[
    { key: 'time', name:'日期/时间', value: "", leftWidth: 100, rightWidth: 200 },
    { key: 'place', name:'地点', value: "", leftWidth: 100, rightWidth: 300, lastChild: true },
    { key: 'host', name:'主持人', value: "", leftWidth: 100, rightWidth: 200 },
    { key: 'check', name:'查房者', value: "", leftWidth: 100, rightWidth: 300, lastChild: true },
    { key: 'join', name:'参加人员', value: "", leftWidth: 100, rightWidth: 600 , preIndex: 2, rightStyle:{ textAlign: "left" } },
...
const tBody2: any = [
  { key: "content2", name: "内容", value: "责任护士：", width: 700, style:{ minHeight: "150px", textAlign: "left", verticalAlign: "top" } },
]
const tBody3: any = [
  { key: "content3", name: "内容", value: "查房者及参加人员：", width: 700, style:{ minHeight: "150px", textAlign: "left", verticalAlign: "top" } },
]
const tBody4: any = [
  { key: "content4", name: "内容", value: "责任护士：", width: 700, style:{ minHeight: "150px", textAlign: "left", verticalAlign: "top" } },
]

const tBody5: any = [
  { key: "content5", name: "内容", value: "主持人：", width: 700, style:{ minHeight: "150px", textAlign: "left", verticalAlign: "top" } },
]
...
export default {
  ...
  tableTitle: { value: `临床护理查房记录`, width: 700 },
  complexHead,
