...
const tHead = {
  top: [
    { name: "序号", colspan: "1", rowspan: "1", style: { width: 48 } },
    ...
    { name: "备注", colspan: "1", rowspan: "1", style: { width: 500 } },
  ],
  mid: [],
  bottom: []
}
...
const tBody: any = [
  { key: "serialNumber", name: "序号", value: "", width: 48 },
  ...
  { key: "remark", name: "备注", value: "", width: 500 },
]
