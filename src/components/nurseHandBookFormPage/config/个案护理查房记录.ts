...
const tBody3: any = [
  { key: "content3", name: "内容", value: "查房者及参加人员：", width: 800, style:{ minHeight: "150px", textAlign: "left", verticalAlign: "top" } },
]
const tBody4: any = [
  { key: "content4", name: "内容", value: "责任护士：", width: 800, style:{ minHeight: "150px", textAlign: "left", verticalAlign: "top" } },
]
...
export default {
  ...
  tableTitle: { value: `个案护理查房记录`, width: 800 },
  complexHead,
