...
const tHead = {
  top: [
    ...
    { name: "会诊人员", colspan: "1", rowspan: "1", style:{ width: 125 } },
    { name: "申请时间", colspan: "1", rowspan: "1", style:{ width: 125 } },
...
const tBody: any = [
  ...
  { key: "personnel", name: "会诊人员", value: "", width: 125 },
  { key: "applyTime", name: "申请时间", value: "", width: 125 },
