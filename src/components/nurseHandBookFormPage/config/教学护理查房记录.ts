...
const tBody3: any = [
  { key: "content3", name: "内容", value: "查房者：", width: 700, style:{ minHeight: "150px", textAlign: "left", verticalAlign: "top" } },
]

const tBody4: any = [
  { key: "content4", name: "内容", value: "低年资护士：", width: 700, style:{ minHeight: "150px", textAlign: "left", verticalAlign: "top" } },
]
...
export default {
  ...
  tableTitle: { value: `教学护理查房记录`, width: 700 },
  complexHead,
