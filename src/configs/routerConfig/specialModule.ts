...
const NursingRulesNew_wh = lazy(() => import('src/modules/nursingRulesNew-wh/NursingRulesNew'))
const NursingRulesNewDetail_wh = lazy(() => import('src/modules/nursingRulesNew-wh/views/NursingRulesNewDetail'))
const NursingRulesPagePreview_wh = lazy(() => import('src/modules/nursingRulesNew-wh/views/NursingRulesPagePreview'))
const NursingRulesNewEdit_wh = lazy(() => import('src/modules/nursingRulesNew-wh/views/NursingRulesNewEdit'))
